...
#    in S on {x in (F2)^n} of (-1)^(f(x) + z.x). The function returns it  #
...
#    function. The support O_f of the function is defined as the set of   #
...
#    for a boolean graph are all integers, every l numerically obtained   #
